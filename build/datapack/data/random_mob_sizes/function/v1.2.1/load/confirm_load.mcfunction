...
#> random_mob_sizes:v1.2.1/load/confirm_load
#
# @within	random_mob_sizes:v1.2.1/load/secondary
#

# Confirm load
tellraw @a[tag=convention.debug] {"text":"[Loaded RandomMobSizes v1.2.1]","color":"green"}
