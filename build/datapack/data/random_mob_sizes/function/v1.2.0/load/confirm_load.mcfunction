...
#> random_mob_sizes:v1.2.0/load/confirm_load
#
# @within	random_mob_sizes:v1.2.0/load/secondary
#

tellraw @a[tag=convention.debug] {"text":"[Loaded RandomMobSizes v1.2.0]","color":"green"}
