...
#> random_mob_sizes:v1.3.6/load/enumerate
#
...
execute if score #random_mob_sizes.major load.status matches 1 if score #random_mob_sizes.minor load.status matches 3 unless score #random_mob_sizes.patch load.status matches 6.. run scoreboard players set #random_mob_sizes.patch load.status 6
