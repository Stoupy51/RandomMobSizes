...
#> random_mob_sizes:v1.2.9/load/enumerate
#
...
execute if score #random_mob_sizes.major load.status matches 1 if score #random_mob_sizes.minor load.status matches 2 unless score #random_mob_sizes.patch load.status matches 9.. run scoreboard players set #random_mob_sizes.patch load.status 9
