...
#> random_mob_sizes:v1.3.0/load/confirm_load
#
# @within	random_mob_sizes:v1.3.0/load/secondary
#

# Confirm load
tellraw @a[tag=convention.debug] {"text":"[Loaded RandomMobSizes v1.3.0]","color":"green"}
