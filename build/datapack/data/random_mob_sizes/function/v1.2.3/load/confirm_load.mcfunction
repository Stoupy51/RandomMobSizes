...
#> random_mob_sizes:v1.2.3/load/confirm_load
#
# @within	random_mob_sizes:v1.2.3/load/secondary
#

# Confirm load
tellraw @a[tag=convention.debug] {"text":"[Loaded RandomMobSizes v1.2.3]","color":"green"}
