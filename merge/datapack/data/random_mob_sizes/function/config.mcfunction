...
tellraw @s {"text":"- Speed Scale: [click]","color":"aqua","click_event":{"action":"suggest_command","command":"/data modify storage random_mob_sizes:config speed_scale set value true"},"hover_event":{"action":"show_text","value":{"text":"Value of 'false' means disabled, 'true' means enabled","color":"gray"}}}
tellraw @s {"text":"- Damage Scale: [click]","color":"aqua","click_event":{"action":"suggest_command","command":"/data modify storage random_mob_sizes:config damage_scale set value true"},"hover_event":{"action":"show_text","value":{"text":"Value of 'false' means disabled, 'true' means enabled","color":"gray"}}}
tellraw @s {"text":"- Individual Mob Settings: [click]","color":"aqua","click_event":{"action":"suggest_command","command":"/data modify storage random_mob_sizes:config mobs.\"minecraft:chicken\" set value {min_size:0.75,max_size:1.25,health_scale:true,speed_scale:false,damage_scale:false}"},"hover_event":{"action":"show_text","value":{"text":"Configuration per mob type in the format:\n{min_size:<value>,max_size:<value>,health_scale:<true/false>,speed_scale:<true/false>,damage_scale:<true/false>}\nEach key that is not specified will use the global values.","color":"gray"}}}
