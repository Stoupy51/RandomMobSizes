...
tellraw @s {"text":"[Random Mob Sizes v1.0]","color":"dark_aqua"}
tellraw @s {"text":"Value range is 625-160000, resulting in a scale range of 0.0625-16.0","color":"aqua"}
tellraw @s {"text":"Default values are 2500-40000, resulting in a scale range of 0.25-4.0","color":"aqua"}
